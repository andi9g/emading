...
<div class="row">
    ...
    <div class="col-md-10">
        <div class="card">
            ...
            <form action="{{ route('konten.update', [$data->idkonten]) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class='form-group'>
                        <label for='forjudul' class='text-capitalize'>Judul Konten <font class="text-danger">*</font></label>
                        <input type='text' name='judul' id='forjudul' class='form-control' placeholder='masukan judul konten' value="{{ $data->judul }}">
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class='form-group'>
                                ...
                                <input type='text' name='tanggal' id='fortanggal' class='form-control' value='{{ $data->tanggal }}'>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="konten" rows="20" cols="100">{{ htmlspecialchars_decode($data->konten) }}</textarea>
                    </div>
...
$(document).ready(function() {
    ...
    $('.js-example-basic-multi').val(tagsArray).trigger('change');
});
</script>
